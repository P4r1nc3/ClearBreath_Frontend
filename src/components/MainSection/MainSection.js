            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 my-5">
                <div className="flex flex-col lg:flex-row items-center">
                    <div className="lg:w-1/2">
                        <h1 className="text-4xl lg:text-5xl font-bold text-blue-400 mb-4">
                            <span className="text-gray-800">Clear</span>Breath!
                        </h1>
                        ...
                        <button className="bg-blue-400 text-white px-6 py-3 rounded hover:bg-blue-500 focus:outline-none focus:bg-blue-700 transition duration-300 ease-in-out">
                            Get Started
                        </button>
                    </div>
                    <div className="lg:w-1/2">
